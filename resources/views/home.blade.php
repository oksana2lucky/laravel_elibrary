...
@section('content')
    ...
    <div class="templatemo_product_box">
        ...
        <img src="{{ URL::asset('images/templatemo_image_01.jpg') }}" alt="image" />
    ...
    <div class="templatemo_product_box">
        ...
        <img src="{{ URL::asset('images/templatemo_image_02.jpg') }}" alt="image" />
        <div class="product_info">
    ...
    <div class="templatemo_product_box">
        ...
        <img src="{{ URL::asset('images/templatemo_image_03.jpg') }}" alt="image" />
        <div class="product_info">
    ...
    <div class="templatemo_product_box">
        ...
        <img src="{{ URL::asset('images/templatemo_image_04.jpg') }}" alt="image" />
        <div class="product_info">
    ...
    <a href="subpage.html"><img src="{{ URL::asset('images/templatemo_ads.jpg') }}" alt="ads" /></a>
